...
```
#review remaining columns.  replace NA values with "Unknown" for character values, 01/01/1970 for dates and 0 for numeric values
```{r}
breach_report %>% filter(`Name of Covered Entity`==""|is.na(`Name of Covered Entity`))
# head or summary for breach_report
# summary(breach_report$Name of Covered Entity)
...
```
##start plotting (evil laugh)
```{r}
ggplot(breach_report, aes(x= Individuals Affected, y=Breach Submission Date))
